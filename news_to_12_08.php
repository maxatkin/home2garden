...
<head>
<title>Wind Dancers and Garden Gifts by Home 2 Garden</title>
<link rel="stylesheet" href="style6.css" type="text/css" media="all">
<style type="text/css" media="all">@import url("style6.css");</style>
...
<meta name="author" content="Max Atkin">
<meta name="keywords" content="Home2garden.co.uk, home2garden, wind dancer, glass products, kinetic scuptures, wind sailors, ribbons, suncatchers, garden rainbow bubbles, oil burners, tree fountains, chrome spiral, copper insects, sundial, garden accents" />
<meta name="description" content="Home2garden web catalog. Sellers of Wind Dancers, Stainless Steel Wind Dancers, Glass Products, Kinetic Sculptures, Wind sailors, ribbons, suncatchers, garden rainbow bubbles, oil burners, tree fountains, chrome spiral, copper insects, sundial, stainless steel garden accents">
<meta name="verify-v1" content="o7CLeR/ywDnNSfuniWiJDw5M9xLOwtdD2Wve8qTKZa8=" />
<script type="text/javascript" src="main_menu.js"></script>
</head>

<body >
<!-- DO NOT MOVE! The following AllWebMenus linking code section must always be placed right AFTER the BODY tag-->
<!-- ******** BEGIN ALLWEBMENUS CODE FOR test_menu ******** -->
<script type="text/javascript">var MenuLinkedBy="AllWebMenus [4]",awmMenuName="test_menu",awmBN="748";awmAltUrl="";</script><script charset="UTF-8" src="test_menu.js" type="text/javascript"></script><script type="text/javascript">awmBuildMenu();</script>
<!-- ******** END ALLWEBMENUS CODE FOR test_menu ******** -->
...
<td width="350"></a>
  <a href="http://www.arcavit.co.uk/h2g_2008/www/"><img src="images/blue_logo.jpg" border="0" />
</td>
<td> 
<table border="0" style="width:500px;"><tr><td style="text-align: center;"><img src="images/inspired.jpg"></td>
</tr>
<tr><td align="center">
<table border="0" style="width:245px;"><tr>
<td width="12px"align="center"><img src="images/pink_dot.jpg"></td>
<td width="62px"align="center">Silent</td>
<td width="12px"align="center"><img src="images/pink_dot.jpg"></td>
<td width="80px"align="center">Soothing</td>
<td width="12px"align="center"><img src="images/pink_dot.jpg"></td>
<td width="72px"align="center">Meditative</td>
</tr>
</table></td>
</tr>
</table>
...
<table id="bluebar" border="0" cellpadding="0" cellspacing="0" width="1000px">
<tr><td width="95px"></td>
<td class="main_menu">
<img src="images/menuback.jpg"></td>
<td width="105px"></td></tr></table>
<?php
include "global.php";
include "file.php";
...
if($trylogin["status"] == "Value"){
...
else if($thankyou["status"] == "Value"){
  $ret = SendPage("thankyou.tem", array(), FALSE);
  ...
  $link = "cat=";
  $category_icon = DisplaySections("indexpage", $link);
...
echo "  <div id=\"ContentContainer\" align=\"center\" >";
echo	"<div>";
include('newsletter_Home2Garden/newsletter1.html');
echo	"</div>
   <div id=\"divOne\" align=\"center\" style=\"padding-top:50px;\"></div>
   
    <script type=\"text/javascript\">
		playerOne = new FAVideo(\"divOne\", \"H2G.flv\",0,0,{ autoLoad:true, autoPlay:true });
	</script>
	...
	ITV's This Morning programme, Sept '07 
