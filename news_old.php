...
<div id="Header">
  <div class="frame" style="float: left; margin-right: 0px;">
    <a href="index.php"><img src="images/newlogo.jpg" border="0" /></a>
  </div>
  <div class="frame" style="float: left; margin-right: 0px;">
    <img style="float: left;" src="images/logoprod5.jpg" />
  </div>
  <div class="frame" style="float: left; margin-right: 0px">
     <img style="float: left;" src="images/logoprod2.jpg" />
  </div>
  <div class="frame" style="float: left; margin-right: 0px;">
    <img style="float: left;" src="images/logoprod6.jpg" />
  </div>
  <div id="TagContainer" align="center">
    <p>Contemporary Garden Accents for the Home and Garden</p>
    <div id="SmallMenu" align="center" style="padding-left:3px;">
      <div class = "menu_element" align="center">
        <a href="index.php?login=true">Login</a>
      </div>
      <div class = "menu_element" align="center">
        <a href="shopping.php">View Basket</a>      </div>
	        <div class = "menu_element" align="center">
        <a href="index.php?aboutus=true">About Us</a>
      </div>
	  <div class = "menu_element" style="margin-right: 0px">
        <a href="pdf.php" target="_blank">Catalogue</a>      </div>
	  <div class = "menu_element" align="center">
